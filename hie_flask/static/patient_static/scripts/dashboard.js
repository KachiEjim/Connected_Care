document.addEventListener('DOMContentLoaded', function() {
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <div class="patient-picture">
                                    <img src="../../static/landing_page_static/img/img1.png" alt="Patient Picture">
                                </div>
                                <div class="card patient-i">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p><strong>Address:</strong> <span>123 Main St, Springfield, IL</span></p>
                                        <p><strong>Occupation:</strong> <span>Software Engineer</span></p>
                                        <p><strong>Marital Status:</strong> <span>Single</span></p>
                                        <p><strong>Emergency Contact:</strong> <span>Jane Doe (Sister) - (987) 654-3210</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
 ...
 case 'statistics-tab':
    ...
    // Function to initialize the health statistics chart
